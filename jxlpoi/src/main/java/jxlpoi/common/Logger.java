...
public abstract class Logger
{
  ...
  private synchronized static void initializeLogger()
  {
    ...
    String loggerName = jxlpoi.common.log.LoggerName.NAME;
    ...
    try
    {
      ...
      if (loggerName == null)
      {
        ...
        loggerName = jxlpoi.common.log.LoggerName.NAME;
      }
    ...
    {
      logger = new jxlpoi.common.log.SimpleLogger();
