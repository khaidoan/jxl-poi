...
package jxlpoi.write;

import jxlpoi.biff.DisplayFormat;
...
import jxlpoi.format.Pattern;
import jxlpoi.format.VerticalAlignment;
import jxlpoi.write.biff.CellXFRecord;
...
public class WritableCellFormat extends CellXFRecord
{
   ...
   * @exception jxlpoi.write.WriteException
   */
