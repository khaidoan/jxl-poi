...
class NameRecord extends WritableRecordData
{
  ...
  static class NameRange
  {
    ...
    NameRange(jxlpoi.read.biff.NameRecord.NameRange nr)
    {
   ...
   */
  public NameRecord(jxlpoi.read.biff.NameRecord sr, int ind)
  {
    super(Type.NAME);
    ...
    // Copy the ranges
    jxlpoi.read.biff.NameRecord.NameRange[] r = sr.getRanges();
