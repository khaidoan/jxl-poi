...
import jxlpoi.biff.EncodedURLHelper;
...
class SupbookRecord extends WritableRecordData
{
   ...
   */
  public SupbookRecord(jxlpoi.read.biff.SupbookRecord sr, WorkbookSettings ws)
  {
    super(Type.SUPBOOK);
   ...
   */
  private void initInternal(jxlpoi.read.biff.SupbookRecord sr)
  {
    numSheets = sr.getNumberOfSheets();
    initInternal();
  }
