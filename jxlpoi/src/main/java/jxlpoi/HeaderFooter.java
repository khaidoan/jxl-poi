 ...
 */
public final class HeaderFooter extends jxlpoi.biff.HeaderFooter
{
  /**
   * The contents - a simple wrapper around a string buffer
   */
  public static class Contents extends jxlpoi.biff.HeaderFooter.Contents
  {
    /**
     * The constructor
     */
   ...
   */
  protected jxlpoi.biff.HeaderFooter.Contents createContents()
  {
    return new Contents();
  }
   ...
   * @return the created contents
   */
  protected jxlpoi.biff.HeaderFooter.Contents createContents(String s)
  {
   ...
   */
  protected jxlpoi.biff.HeaderFooter.Contents
    createContents(jxlpoi.biff.HeaderFooter.Contents c)
  {
