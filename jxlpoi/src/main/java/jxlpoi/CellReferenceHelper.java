...
public final class CellReferenceHelper
{
  ...
  {
    jxlpoi.biff.CellReferenceHelper.getCellReference(column, row, buf);
  }
  ...
  public static void getCellReference(int column,
                                      ...
                                      StringBuffer buf)
  {
    jxlpoi.biff.CellReferenceHelper.getCellReference(column, colabs,
                                                  row, rowabs,
                                                  buf);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.getCellReference(column, row);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.getColumn(s);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.getColumnReference(c);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.getRow(s);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.isColumnRelative(s);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.isRowRelative(s);
  }
  ...
  {
    jxlpoi.biff.CellReferenceHelper.getCellReference
      (sheet, column, row, (jxlpoi.biff.formula.ExternalSheet) workbook, buf);
  }
                                       ...
                                       StringBuffer buf)
  {
    jxlpoi.biff.CellReferenceHelper.getCellReference
      (sheet, column, colabs, row, rowabs,
       (jxlpoi.biff.formula.ExternalSheet) workbook, buf);
  }
  ...
  public static String getCellReference (int sheet,
                                         ...
                                         Workbook workbook)
  {
    return jxlpoi.biff.CellReferenceHelper.getCellReference
      (sheet, column, row, (jxlpoi.biff.formula.ExternalSheet) workbook);
  }
  ...
  {
    return jxlpoi.biff.CellReferenceHelper.getSheet(ref);
  }
